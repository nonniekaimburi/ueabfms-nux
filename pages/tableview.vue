            ...
            <table class="w-full">
              ...
              <tbody>
                ...
                >
                  ...
                  >
                    <nuxt-link
                      :to="{ name: 'stude-id', params: { id: student.id } }"
                    >
...
const searchedfiles = computed(() => {
  return students.value.filter((student) => {
    return (
      student.sclid.toUpperCase().match(search.value.toUpperCase()) ||
      student.Lastname.toUpperCase().match(search.value.toUpperCase()) ||
      student.Firstname.toUpperCase().match(search.value.toUpperCase())
    );
  });
});
const users = ref([]);
