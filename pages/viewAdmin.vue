              ...
              <table class="min-w-full">
                ...
                <tbody>
                  <tr class="border" v-for="(user,index) in users" :key="index">
                    <td v-if="user.admin" class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 border-r-2">{{index +1}}</td>
                    <td v-if="user.admin" class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r-2">{{user.email}}</td>
                    <td v-if="user.admin" class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap first-letter border-r-2">{{user.admin}}</td>
                    <td v-if="user.admin" class="text-sm text-gray-900 font-light px-6 py-4 whitespace-nowrap border-r-2 w-36">
                      <button v-if="user.admin" class="px-4 bg-orange-500 rounded py-2 mx-2" @click="openModal">
                       <span>Restrict</span>
                      </button>
                      <button v-if="!user.admin" class="px-4 bg-orange-500 rounded py-2 mx-2" @click="openModal(user.id)">
                    ...
                    <TransitionRoot appear :show="isOpen" as="template" v-if="user.admin">
